...
g1 <- plot_bloco(sim_y_fraco, col = 1,   titulo = "Conjunto 1",   cores = cores_fraco) + coord_cartesian(ylim = c(65, 135))
g2 <- plot_bloco(sim_y_fraco, col = 400, titulo = "Conjunto 400", cores = cores_fraco) + coord_cartesian(ylim = c(65, 135))
g3 <- plot_bloco(sim_y_fraco, col = 800, titulo = "Conjunto 800", cores = cores_fraco) + coord_cartesian(ylim = c(65, 135))

g4 <- plot_bloco(sim_y_inter, col = 1,   titulo = "Conjunto 1",   cores = cores_intermediario) + coord_cartesian(ylim = c(65, 135))
g5 <- plot_bloco(sim_y_inter, col = 400, titulo = "Conjunto 400", cores = cores_intermediario) + coord_cartesian(ylim = c(65, 135))
g6 <- plot_bloco(sim_y_inter, col = 800, titulo = "Conjunto 800", cores = cores_intermediario) + coord_cartesian(ylim = c(65, 135))

g7 <- plot_bloco(sim_y_forte, col = 1,   titulo = "Conjunto 1",   cores = cores_forte) + coord_cartesian(ylim = c(65, 135))
g8 <- plot_bloco(sim_y_forte, col = 400, titulo = "Conjunto 400", cores = cores_forte) + coord_cartesian(ylim = c(65, 135))
g9 <- plot_bloco(sim_y_forte, col = 800, titulo = "Conjunto 800", cores = cores_forte) + coord_cartesian(ylim = c(65, 135))
...
df_res <- data.frame(
  ...
  modelo  = rep(c("DIC", "BIC"), each = nrow(df_obs)),
...
ggplot(df_res, aes(x = trat, y = residuo, color = bloco)) +
  ...
  labs(title = "Resíduos por tratamento — DIC vs BIC (bloco forte)",
       x     = "Tratamento",
       y     = "Resíduo",
       color = NULL) +
  theme_minimal(base_size = 13, base_family = "serif") +
